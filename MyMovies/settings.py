...
#     /home2/sintramu/Projects/MyMovies/static
#     os.path.join('Projects/MyMovies/static' , 'static').replace('\\','/')
#     os.path.join('public_html/MyMovies/static' , 'static').replace('\\','/')
...
SECRET_KEY = '_3lr87oe2wyl5^+8s$5xdvovr!2#j7thxwfs^&amp;h@^%lok=^(ik'
